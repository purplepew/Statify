...
class DataLabWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        data_lab_btn = tk.Button(nav_frame, text="Stats Basics", relief="flat",font=("Verdana",10,"bold"), fg="white", bg="#6c0987", command=lambda: stat_basic.StatBasic(self))
        data_lab_btn.pack(side="right", padx=15)
        ...
        tk.Button(main_content, text="Descriptive Statistics",fg = "white",bg = "#6c0987",font=("Verdana",10,"bold"), padx=10, pady=10,command=lambda: descriptive.Descriptive(self)).pack()
        tk.Label(main_content, bg="#d871f5").pack(pady=1)
        tk.Button(main_content, text="Inferential Statistics",fg = "white",bg = "#6c0987",font=("Verdana",10,"bold"), padx=11, pady=10, command=lambda: inferential.Inferential(self)).pack()
        tk.Label(main_content, bg="#d871f5").pack(expand=True)
